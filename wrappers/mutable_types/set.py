...
class SetWrapper(Wrapper):
    ...
    def to(self, new_value: Union[set, Wrapper, Any]) -> Wrapper:
    ...
    def copy(self) -> "SetWrapper":
        return self.__class__(self.data)

    # The following apply to the set unless the wrapper has the attribute/key.
    ...
    # The following operations act as if they are the set.
