...
class ModelWrapper(Wrapper):
    def __init__(self, value: torch.nn.Module):
        self.data = value

    def to(self, new_value: Union[torch.nn.Module, Wrapper, Any]) -> Wrapper:
    ...
    def resolve(self) -> torch.nn.Module:
        return self.data

    # The following apply to the model unless the wrapper has the attribute/key.
    ...
    # The following operations act as if they are the model.
